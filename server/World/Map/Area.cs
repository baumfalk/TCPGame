...
namespace TCPGameServer.World.Map
{
    public class Area
    {
        ...
        private String[] ParseTiles(int numTiles, StreamReader fileReader) {
        ...
        private void ParseTile(int index, String[] tileData)
        {
            ...
            tiles[index] = new Tile(type, representation, x, y, z, index, this, world);
        }

        // links the tiles in the area together
        private void LinkTiles(int numTiles, String[] links) {
